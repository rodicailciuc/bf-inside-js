...
/**
 * tell's if a string is long or short
 *
 * @param {string} text - the value of string
 * @param {number} cutoff - the number to cutoff
 * @return {string} return the value after cutoff
 */
